    ...
    return (
        ...
        sx={{
            ...
            sx={{
                ...
                <TertiaryButton 
                    title="Add Manually" 
                    bgColor={theme.customTheme.Color.Primary.Blue}
                    textColor={theme.customTheme.Color.Primary.White}
                    icon={<PlusCircleIcon color={theme.customTheme.Color.Primary.Blue} fill={theme.customTheme.Color.Primary.White}/>}
                /> 
                <TertiaryButton 
...
export const UpdateHalidays: React.FC<LocationProps> = (props) => {
    return (                    
        <Drawer
